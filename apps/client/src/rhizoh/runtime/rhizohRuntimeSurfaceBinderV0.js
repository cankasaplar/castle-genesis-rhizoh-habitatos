...
export function bindRhizohRuntimeSurfaceV0(target) {
  ...
  rhizoh.ingestMediaEvent = (raw) =>
    ingestMediaTimelineEventV0(normalizeMediaTimelineEventV0(raw));
  rhizoh.ingestUserActivity = (raw) =>
    ingestUserActivityEventV0(normalizeUserActivityEventV0(raw));
