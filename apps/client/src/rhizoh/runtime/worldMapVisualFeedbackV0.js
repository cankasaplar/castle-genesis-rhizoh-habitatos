...
import { shouldMuteVoiceOutputV0 } from "./temporalBridgeV0.js";
...
export function emitMapGhostTrailHintV0(detail = {}) {
  ...
  if (Number.isFinite(lat) && Number.isFinite(lon) && !shouldMuteVoiceOutputV0()) {
...
export function speakMapCommandAckV0(detail = {}) {
  if (shouldMuteVoiceOutputV0()) return false;
