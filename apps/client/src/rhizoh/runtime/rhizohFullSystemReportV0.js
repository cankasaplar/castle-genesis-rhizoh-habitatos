...
export function printFullSystemReportV0(report) {
  ...
  const lines = [
    ...
    "───────────────────────────────────────────",
    "  ACADEMIC PAPER v0.1",
    `    read: https://rhizoh.com/rhizoh/academic/paper-v0.1.html`,
    `    download: await __rhizoh.downloadPaperV01({ locale: "tr" }) · /academy`,
    `    audit: await __rhizoh.epistemicAuditBundle.run()`,
    "───────────────────────────────────────────",
    "  LIFE OS v0.1",
