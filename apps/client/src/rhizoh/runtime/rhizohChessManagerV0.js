...
export function getRhizohChessManagerSnapshotV0(reason = "poll") {
  ...
  return Object.freeze({
    ...
    probes: Object.freeze({
      ...
      learning: "window.__RHIZOH_CHESS_LEARNING_LIVE__()",
      learningSnapshot: "window.__rhizoh.chessLearningMonitor",
      memory: "window.__rhizoh.chessClusterMemory",
      learningReport: "await window.__rhizoh.learningReport()",
      managerLive: "window.__RHIZOH_CHESS_MANAGER_LIVE__()",
