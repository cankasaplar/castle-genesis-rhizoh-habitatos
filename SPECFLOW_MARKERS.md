...
**UGL multi-domain routing (chess-complete · sports scaffold):** [`docs/RHIZOH_UGL_V1.md`](docs/RHIZOH_UGL_V1.md) · [`docs/RHIZOH_DOMAIN_FABRIC_V0.md`](docs/RHIZOH_DOMAIN_FABRIC_V0.md) · [`docs/RHIZOH_ARENA_ROUTER_V0.md`](docs/RHIZOH_ARENA_ROUTER_V0.md) — `RESEARCH-ONLY` / `FUTURE-PROOF-ONLY`; `rhizohDomainFabricV0.js` · `rhizohArenaRouterV0.js` · `rhizohUglSportsAdapterV0.js` (stub). Not: `chessGameRouterV0` = chess cluster only; cross-domain = `rhizohArenaRouterV0`.
