...
**Ticket network (UX unification over existing subsystems):** [`docs/RHIZOH_TICKET_NETWORK_SCHEMA_V1.md`](docs/RHIZOH_TICKET_NETWORK_SCHEMA_V1.md) — `RESEARCH-ONLY` / `FUTURE-PROOF-ONLY`; Capability + Journey; not a parallel execution engine.
