...
**Ticket network (UX unification over existing subsystems):** [`docs/RHIZOH_SECURITY_BOUNDARY_V1.md`](docs/RHIZOH_SECURITY_BOUNDARY_V1.md) (constitutional — read first) · [`docs/RHIZOH_REALITY_TRANSITION_ENGINE_V1.md`](docs/RHIZOH_REALITY_TRANSITION_ENGINE_V1.md) · [`docs/RHIZOH_TICKET_NETWORK_SCHEMA_V1.md`](docs/RHIZOH_TICKET_NETWORK_SCHEMA_V1.md) · [`docs/RHIZOH_STATE_TRANSITIONS_V1.md`](docs/RHIZOH_STATE_TRANSITIONS_V1.md) — `RESEARCH-ONLY` / `FUTURE-PROOF-ONLY`; Capability + Journey; not a parallel execution engine.
