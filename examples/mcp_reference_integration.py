...
class RhizohMCPMiddleware:
    ...
    def intercept_mcp_tool_call(self, mcp_request: Dict[str, Any], context_evidence: Dict[str, Any]) -> Tuple[Dict[str, Any], str]:
        ...
        if evaluation["decision"] == "ALLOW":
            ...
            response = {
                ...
                "error": {
                    "code": -32002,
                    "message": "Execution Rejected: Policy or capability boundary violation.",
