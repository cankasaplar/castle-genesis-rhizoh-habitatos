export const WS_MESSAGE = {
  ...
  MATCH_SESSION_PRESENCE: "MATCH_SESSION_PRESENCE",
  /** Castle-to-castle chess invite — gateway fan-out to peers (inbox projection). */
  MATCH_CASTLE_INVITE: "MATCH_CASTLE_INVITE",
