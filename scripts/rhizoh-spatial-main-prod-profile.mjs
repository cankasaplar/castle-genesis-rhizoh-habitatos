...
/** Castle Genesis YouTube — baked for spatial-main prod (live embed + channel SSOT). */
export const RHIZOH_SPATIAL_MAIN_MEDIA_YOUTUBE_DEFAULTS_V0 = Object.freeze({
  VITE_CASTLE_GENESIS_YOUTUBE_CHANNEL_ID: "UC24Uv9xXfNkEVO0s7huGQFA",
...
export const RHIZOH_SPATIAL_MAIN_PROD_DEFAULTS_V0 = Object.freeze({
  ...
  ...RHIZOH_SPATIAL_MAIN_MEDIA_YOUTUBE_DEFAULTS_V0,
...
export const RHIZOH_PROD_OPTIONAL_KEYS_V0 = Object.freeze([
  "VITE_CASTLE_GENESIS_YOUTUBE_SHORT_VIDEO_ID",
  "VITE_CASTLE_GENESIS_YOUTUBE_CHESS_VIDEO_ID",
  "VITE_CASTLE_GENESIS_YOUTUBE_CHANNEL_ID",
  "VITE_CASTLE_GENESIS_YOUTUBE_ARCHITECTURE_VIDEO_ID",
  "VITE_CASTLE_GENESIS_YOUTUBE_FULL_VIDEO_ID",
  "VITE_CASTLE_GENESIS_YOUTUBE_FULL_EMBED_END_SEC",
  "VITE_RHIZOH_WORLDSPORTS_YOUTUBE_VIDEO_ID",
  "VITE_RHIZOH_WORLDNEWS_YOUTUBE_VIDEO_ID",
