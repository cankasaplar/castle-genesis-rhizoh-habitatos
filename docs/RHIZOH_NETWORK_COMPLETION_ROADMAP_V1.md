...
**Parent:** [`RHIZOH_PRODUCTIZATION_PHASE_GATE_V0.1.md`](academic/RHIZOH_PRODUCTIZATION_PHASE_GATE_V0.1.md) · [`RHIZOH_DISTRIBUTED_REALITY_CONSTRUCTION_PAPER_V0.1.md`](academic/RHIZOH_DISTRIBUTED_REALITY_CONSTRUCTION_PAPER_V0.1.md) · [`RHIZOH_PRODUCT_LAYER_UNLOCK_MAP_V1.md`](RHIZOH_PRODUCT_LAYER_UNLOCK_MAP_V1.md)
